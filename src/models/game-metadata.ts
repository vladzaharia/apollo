...
export const DaijishoPlatformConfigSchema = z.object({
  ...
  platform: z.object({
    ...
    scraperSourceList: z.array(z.string()),
    boxArtAspectRatioId: z.number(),
    useCustomBoxArtAspectRatio: z.boolean(),
    customBoxArtAspectRatio: z.string().nullable(),
    screenAspectRatioId: z.number(),
    useCustomScreenAspectRatio: z.boolean(),
    customScreenAspectRatio: z.string().nullable(),
    retroAchievementsAlias: z.string().nullable(),
    retroAchievementsConsoleIdList: z.array(z.number()).optional(),
    extra: z.string(),
  }),
